...
public class RecordService extends Shbase {
	...
	public void Record() throws InterruptedException {
		...
		test = extent.createTest("Record Service", "All types of services");
		...
		//click on any schedule for service
		driver.findElement(By.xpath("//android.widget.TextView[@text='সেবা দিন']")).click();
		...
		test.log(Status.PASS, "Test Case - 26: Validate sickness list to Medicine types > Medicine list branching inside prescription (Successful)");
		...
		driver.findElement(By.id("com.mpower.android.app.lpin.crm:id/acivSubmitDialog")).click();
		test.log(Status.PASS, "Test Case - 27: Add new medicine (Successful)");
		//submit medicine
		...
		if(nextday == "2") {
			test.log(Status.PASS, "Test Case - 28: Reschedule next visit (Successful)");
		}else {
			test.log(Status.FAIL, "Test Case - 28: Reschedule next visit");
		}
		...
		if (driver.findElements(By.id("com.mpower.android.app.lpin.crm:id/actvMsgCustomDialog")).size() > 0) {
			test.log(Status.PASS, "Test Case - 32: Service fee tracking reminder (Successful)");
			driver.findElement(By.id("com.mpower.android.app.lpin.crm:id/actvNegCustomDialog")).click();
			driver.findElement(By.id("com.mpower.android.app.lpin.crm:id/actvNegCustomDialog")).click();
        } else {
        	test.log(Status.FAIL, "Test Case - 32: Service fee tracking reminder");
        }
		...
		if (driver.findElements(By.id("com.mpower.android.app.lpin.crm:id/actvMsgCustomDialog")).size() > 0) {
			test.log(Status.PASS, "Test Case - 33: Send message to farmer reminder (Successful)");
        } else {
        	test.log(Status.FAIL, "Test Case - 33: Send message to farmer reminder");
        }

		//select "No" for prescription SMS
		driver.findElement(By.id("com.mpower.android.app.lpin.crm:id/actvNegCustomDialog")).click();
		test.log(Status.PASS, "Test Case - 29: Add Service fee (Successful)");
		//fee submission<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<END
		...
		test.log(Status.PASS, "Test Case - 23: Add Bull number in Artificial Insemination (Successful)");
		...
		test.log(Status.PASS, "Test Case - 24: Take/upload photo of cow in Artificial Insemination (Successful)");
		//select milk yes/no
		...
		if (driver.findElements(By.xpath("//android.widget.TextView[@text='ষাঁড় আইডি']")).size() > 0) {
			test.log(Status.FAIL, "Test Case - 25: Service type change after filling random fields");
        } else {
        	test.log(Status.PASS, "Test Case - 25: Service type change after filling random fields (Successful)");
        }
